"""시도 → 시군구 LAWD_CD(법정동 5자리) 매핑 — 전국 17개 시도

검증일: 2026-05-15 (RTMSDataSvcAptTrade 직접 ping 테스트로 확인)
- 행정구가 있는 시(천안·청주·전주·창원)는 통합 코드가 0건 → 구별 분리
- 강원·전북은 특별자치도 출범 후 신코드(51, 52)가 정상
- 그 외 시도는 기존 행정안전부 표준 5자리 코드 그대로
"""
